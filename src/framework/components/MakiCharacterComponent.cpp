...
namespace Maki
{
	...
	const float CharacterComponent::TURN_SPEED = 8.0f;
	const float CharacterComponent::CAM_TURN_SPEED = 4.0f;
	const float CharacterComponent::MOVE_SPEED = 2.0f;

	CharacterComponent::CharacterComponent()
		: Component(COMPONENT_TYPE), body(nullptr)
	{
	}
	...
	void CharacterComponent::Attach(Entity *owner)
	{
		...
		btRigidBody::btRigidBodyConstructionInfo info(80.0f, &owner->physicsLink, container, btVector3(0,0,0));
