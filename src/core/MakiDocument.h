	...
	namespace core {
		...
		public:
			...
			public:
				...
				bool resolve_as_int(const char *node_path, int32_t *out) const;
				int32_t resolve_as_int(const char *node_path, int32_t default_value = 0ll) const;
				
				bool resolve_as_uint(const char *node_path, uint32_t *out) const;
				uint32_t resolve_as_uint(const char *node_path, uint32_t default_value = 0ull) const;
		...
		public:
			...
			inline node_t &root() { return *root_; }
		...
		public:
			...
			bool deserialize(char *data, size_t length);
		...
		public:
			static bool is_binary_document(char *data, size_t length);
