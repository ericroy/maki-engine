	...
	namespace core
	{
		...
		public:
			...
			public:
				...
				int32_t value_as_int(int32_t default_value = 0) const;
				bool value_as_int(int32_t *out) const;

				uint32_t value_as_uint(uint32_t default_value = 0) const;
				bool value_as_uint(uint32_t *out) const;
				...
				inline bool resolve_as_int(const char *node_path, int32_t *out) { document_t::node_t *n = resolve(node_path); if(n) { return n->value_as_int(out); } return false; }
				inline int32_t resolve_as_int(const char *node_path, int32_t default_value = 0) { document_t::node_t *n = resolve(node_path); if(n) { return n->value_as_int(default_value); } return default_value; }
				inline bool resolve_as_uint(const char *node_path, uint32_t *out) { document_t::node_t *n = resolve(node_path); if(n) { return n->value_as_uint(out); } return false; }
				inline uint32_t resolve_as_uint(const char *node_path, uint32_t default_value = 0) { document_t::node_t *n = resolve(node_path); if(n) { return n->value_as_uint(default_value); } return default_value; }
				...
				inline bool resolve_as_vector_n(const char *node_path, uint32_t count, float *out) {
		...
		public:
			...
			bool load(char *data, uint32_t length);
	#ifndef MAKI_TOOLS
			bool load(rid_t rid);
	#endif
